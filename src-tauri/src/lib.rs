...
mod app_init {
    ...
    pub fn generate_handlers() -> impl Fn(tauri::ipc::Invoke<tauri::Wry>) -> bool + Send + Sync + 'static {
        tauri::generate_handler![
            ...
            cmd::get_node_benchmark_snapshot,
            cmd::preview_node_benchmark_candidates,
            cmd::save_node_benchmark_settings,
            cmd::start_node_benchmark,
            cmd::pause_node_benchmark,
            cmd::refresh_node_benchmark_profiles,
            cmd::update_node_benchmark_node,
            cmd::retest_node_benchmark_nodes,
            cmd::clear_node_benchmark_history,
            cmd::cancel_node_benchmark_task,
            cmd::start_node_benchmark_manual_batch,
            cmd::get_node_benchmark_manual_batch,
            cmd::cancel_node_benchmark_manual_batch,
            cmd::get_app_dir,
            cmd::copy_icon_file,
