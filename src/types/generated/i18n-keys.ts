...
export const translationKeys = [
  ...
  'layout.components.navigation.tabs.benchmark',
  ...
  'node-benchmark.navigation',
  'node-benchmark.title',
  'node-benchmark.subtitle',
  'node-benchmark.loading',
  'node-benchmark.empty',
  'node-benchmark.sections.overview',
  'node-benchmark.actions.save',
  'node-benchmark.actions.saveAndPreview',
  'node-benchmark.actions.confirmCandidates',
  'node-benchmark.actions.saveSelection',
  'node-benchmark.actions.useKeywordSelection',
  'node-benchmark.actions.selectAllCandidates',
  'node-benchmark.actions.clearCandidates',
  'node-benchmark.actions.start',
  'node-benchmark.actions.pause',
  'node-benchmark.actions.run',
  'node-benchmark.actions.stop',
  'node-benchmark.actions.refresh',
  'node-benchmark.actions.retest',
  'node-benchmark.actions.cancel',
  'node-benchmark.actions.exclude',
  'node-benchmark.actions.observe',
  'node-benchmark.actions.participate',
  'node-benchmark.actions.snooze',
  'node-benchmark.actions.ignore',
  'node-benchmark.actions.clearSelection',
  'node-benchmark.actions.clearHistory',
  'node-benchmark.notices.saved',
  'node-benchmark.notices.saveIncomplete',
  'node-benchmark.notices.nodesConfirmed',
  'node-benchmark.notices.started',
  'node-benchmark.notices.paused',
  'node-benchmark.notices.refreshed',
  'node-benchmark.notices.updated',
  'node-benchmark.notices.retestQueued',
  'node-benchmark.notices.confirmExclude',
  'node-benchmark.notices.estimatedOverLimit',
  'node-benchmark.settings.title',
  'node-benchmark.settings.stepOneTitle',
  'node-benchmark.settings.stepOneHelp',
  'node-benchmark.settings.saveDoesNotStart',
  'node-benchmark.settings.automaticPreview',
  'node-benchmark.settings.enabled',
  'node-benchmark.settings.enabledHelp',
  'node-benchmark.settings.profiles',
  'node-benchmark.settings.profileSummary',
  'node-benchmark.settings.profileUnavailable',
  'node-benchmark.settings.nodeCount',
  'node-benchmark.settings.include',
  'node-benchmark.settings.includeHelp',
  'node-benchmark.settings.exclude',
  'node-benchmark.settings.excludeHelp',
  'node-benchmark.settings.caseSensitive',
  'node-benchmark.settings.preview',
  'node-benchmark.settings.latencyInterval',
  'node-benchmark.settings.speedInterval',
  'node-benchmark.settings.downloadLimit',
  'node-benchmark.settings.uploadLimit',
  'node-benchmark.settings.duration',
  'node-benchmark.settings.maxBytes',
  'node-benchmark.settings.latencyUrl',
  'node-benchmark.settings.downloadUrl',
  'node-benchmark.settings.uploadUrl',
  'node-benchmark.settings.multiplier',
  'node-benchmark.settings.frequencyMinutes',
  'node-benchmark.settings.frequencyHours',
  'node-benchmark.candidates.title',
  'node-benchmark.candidates.help',
  'node-benchmark.candidates.pending',
  'node-benchmark.candidates.confirmed',
  'node-benchmark.candidates.scopeChanged',
  'node-benchmark.candidates.empty',
  'node-benchmark.candidates.loading',
  'node-benchmark.candidates.loaded',
  'node-benchmark.candidates.filterEmpty',
  'node-benchmark.candidates.pendingWhileRunning',
  'node-benchmark.candidates.search',
  'node-benchmark.candidates.profile',
  'node-benchmark.candidates.node',
  'node-benchmark.candidates.type',
  'node-benchmark.candidates.rule',
  'node-benchmark.candidates.ruleIncluded',
  'node-benchmark.candidates.ruleExcluded',
  'node-benchmark.candidates.confirmHelp',
  'node-benchmark.control.title',
  'node-benchmark.control.runningHelp',
  'node-benchmark.control.pausedHelp',
  'node-benchmark.control.confirmFirst',
  'node-benchmark.control.saveFirst',
  'node-benchmark.control.selectFirst',
  'node-benchmark.history.title',
  'node-benchmark.history.warning',
  'node-benchmark.history.preserved',
  'node-benchmark.history.stopFirst',
  'node-benchmark.history.confirm',
  'node-benchmark.history.cancel',
  'node-benchmark.history.cleared',
  'node-benchmark.windows.sixHours',
  'node-benchmark.windows.twelveHours',
  'node-benchmark.windows.oneDay',
  'node-benchmark.windows.sevenDays',
  'node-benchmark.windows.longTerm',
  'node-benchmark.windows.summary',
  'node-benchmark.windows.help',
  'node-benchmark.champions.overall',
  'node-benchmark.champions.download',
  'node-benchmark.champions.upload',
  'node-benchmark.champions.latency',
  'node-benchmark.champions.waiting',
  'node-benchmark.champions.official',
  'node-benchmark.champions.provisional',
  'node-benchmark.champions.score',
  'node-benchmark.champions.source',
  'node-benchmark.traffic.title',
  'node-benchmark.traffic.help',
  'node-benchmark.traffic.estimated',
  'node-benchmark.traffic.actual',
  'node-benchmark.traffic.limit',
  'node-benchmark.traffic.download',
  'node-benchmark.traffic.upload',
  'node-benchmark.traffic.total',
  'node-benchmark.traffic.billed',
  'node-benchmark.traffic.source',
  'node-benchmark.traffic.summary',
  'node-benchmark.task.title',
  'node-benchmark.task.idle',
  'node-benchmark.task.waiting',
  'node-benchmark.task.paused',
  'node-benchmark.task.running',
  'node-benchmark.task.preparing',
  'node-benchmark.task.checkingNetwork',
  'node-benchmark.task.startingCore',
  'node-benchmark.task.latency',
  'node-benchmark.task.download',
  'node-benchmark.task.upload',
  'node-benchmark.task.cooldown',
  'node-benchmark.task.waitingForOtherQueue',
  'node-benchmark.task.cancelled',
  'node-benchmark.task.failed',
  'node-benchmark.task.latencyQueue',
  'node-benchmark.task.speedQueue',
  ...
  'node-benchmark.task.dueNow',
  'node-benchmark.task.nextAt',
  'node-benchmark.task.noScheduledNode',
  'node-benchmark.task.lastQueueError',
  'node-benchmark.task.retryHelp',
  'node-benchmark.table.title',
  'node-benchmark.table.visible',
  'node-benchmark.table.summary',
  'node-benchmark.table.search',
  'node-benchmark.table.allSources',
  'node-benchmark.table.stateFilter',
  'node-benchmark.table.allStates',
  'node-benchmark.table.sort',
  'node-benchmark.table.groupBySource',
  'node-benchmark.table.sortOptions.overall',
  'node-benchmark.table.sortOptions.download',
  'node-benchmark.table.sortOptions.upload',
  'node-benchmark.table.sortOptions.latency',
  'node-benchmark.table.sortOptions.profile',
  'node-benchmark.table.profile',
  'node-benchmark.table.node',
  'node-benchmark.table.state',
  'node-benchmark.table.stability',
  'node-benchmark.table.download',
  'node-benchmark.table.upload',
  'node-benchmark.table.latency',
  'node-benchmark.table.score',
  'node-benchmark.table.confidence',
  'node-benchmark.table.actions',
  'node-benchmark.table.rank',
  'node-benchmark.table.samples',
  'node-benchmark.table.latencyDetail',
  'node-benchmark.table.stabilityDetail',
  'node-benchmark.table.attemptDetail',
  'node-benchmark.table.nextTest',
  'node-benchmark.table.lastFailed',
  'node-benchmark.table.peak',
  'node-benchmark.table.noData',
  'node-benchmark.states.participating',
  'node-benchmark.states.observe',
  'node-benchmark.states.excluded',
  'node-benchmark.states.changed',
  'node-benchmark.states.removed',
  'node-benchmark.confidence.temporary',
  'node-benchmark.confidence.initial',
  'node-benchmark.confidence.daily',
  'node-benchmark.confidence.longTerm',
  'node-benchmark.reminders.title',
  'node-benchmark.reminders.countSummary',
  'node-benchmark.reminders.summary',
  'node-benchmark.reminders.speed',
  'node-benchmark.reminders.saving',
  'node-benchmark.changes.title',
  'node-benchmark.changes.countSummary',
  'node-benchmark.changes.added',
  'node-benchmark.changes.removed',
  'node-benchmark.changes.renamed',
  'node-benchmark.changes.configurationChanged',
  'node-benchmark.changes.profileRenamed',
  'node-benchmark.changes.profileRemoved',
  ...
  'proxies.page.tooltips.downloadSpeedTest',
  ...
  'proxies.page.speedTest.title',
  'proxies.page.speedTest.hint',
  'proxies.page.speedTest.fields.mode',
  'proxies.page.speedTest.fields.source',
  'proxies.page.speedTest.fields.preset',
  'proxies.page.speedTest.fields.sort',
  'proxies.page.speedTest.fields.includeInRanking',
  'proxies.page.speedTest.fields.sortHint',
  'proxies.page.speedTest.fields.customUrl',
  'proxies.page.speedTest.fields.customUrlHint',
  'proxies.page.speedTest.fields.customUploadUrlHint',
  'proxies.page.speedTest.modes.download',
  'proxies.page.speedTest.modes.upload',
  'proxies.page.speedTest.modes.downloadHint',
  'proxies.page.speedTest.modes.uploadHint',
  'proxies.page.speedTest.sources.cloudflare.name',
  'proxies.page.speedTest.sources.cloudflare.description',
  'proxies.page.speedTest.sources.bunny.name',
  'proxies.page.speedTest.sources.bunny.description',
  'proxies.page.speedTest.sources.hetzner.name',
  'proxies.page.speedTest.sources.hetzner.description',
  'proxies.page.speedTest.sources.custom.name',
  'proxies.page.speedTest.sources.custom.description',
  'proxies.page.speedTest.presets.quick.name',
  'proxies.page.speedTest.presets.quick.description',
  'proxies.page.speedTest.presets.balanced.name',
  'proxies.page.speedTest.presets.balanced.description',
  'proxies.page.speedTest.presets.extended.name',
  'proxies.page.speedTest.presets.extended.description',
  'proxies.page.speedTest.sorts.default',
  'proxies.page.speedTest.sorts.speedDesc',
  'proxies.page.speedTest.sorts.speedAsc',
  'proxies.page.speedTest.sorts.trafficDesc',
  'proxies.page.speedTest.sorts.uploadTrafficDesc',
  'proxies.page.speedTest.sorts.durationAsc',
  'proxies.page.speedTest.sorts.nameAsc',
  'proxies.page.speedTest.actions.start',
  'proxies.page.speedTest.actions.stop',
  'proxies.page.speedTest.actions.testOne',
  'proxies.page.speedTest.actions.retestOne',
  'proxies.page.speedTest.labels.presetSummary',
  'proxies.page.speedTest.columns.name',
  'proxies.page.speedTest.columns.type',
  'proxies.page.speedTest.columns.speed',
  'proxies.page.speedTest.columns.traffic',
  'proxies.page.speedTest.columns.uploadSpeed',
  'proxies.page.speedTest.columns.uploadTraffic',
  'proxies.page.speedTest.columns.duration',
  'proxies.page.speedTest.columns.status',
  'proxies.page.speedTest.columns.action',
  'proxies.page.speedTest.statuses.idle',
  'proxies.page.speedTest.statuses.testing',
  'proxies.page.speedTest.statuses.uploading',
  'proxies.page.speedTest.statuses.success',
  'proxies.page.speedTest.statuses.failed',
  'proxies.page.speedTest.messages.empty',
  'proxies.page.speedTest.messages.sourceRequired',
  'proxies.page.speedTest.messages.restoreFailed',
  'proxies.page.speedTest.messages.stopped',
